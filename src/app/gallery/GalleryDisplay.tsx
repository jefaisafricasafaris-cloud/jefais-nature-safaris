  ...
  return (
    <main className="min-h-screen bg-[#f8f6f1] pt-28 pb-16">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative mb-12 h-[55vh] min-h-[420px] max-h-[680px] overflow-hidden rounded-3xl shadow-2xl">
          <Image
            src="/images/gallery/gorilla567.webp"
          ...
          <div className="absolute inset-0 flex items-center justify-center px-6 text-center">
            <div className="max-w-4xl text-white">
              <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-white/85 sm:text-base">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/90 sm:text-lg">
                Discover unforgettable moments from gorilla trekking,
                wildlife safaris, landscapes, culture and adventures across
                Uganda.
              </p>

              <a
                href="#gallery"
                className="mt-7 inline-flex rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#1b2a16] shadow-lg transition hover:-translate-y-0.5 hover:bg-[#f3eee5]"
              >
                Explore the Gallery
              </a>
            </div>
      ...
      >
        <div className="mb-10 text-center">
          ...
          <h2 className="font-display text-3xl font-semibold text-[#1b2a16] sm:text-4xl">
